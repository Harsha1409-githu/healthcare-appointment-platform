  ...
  return (
    <div className="min-h-screen bg-slate-50 py-10">
      <div className="max-w-7xl mx-auto px-6">
        <section className="relative overflow-hidden bg-gradient-to-br from-slate-950 via-blue-950 to-cyan-900 rounded-3xl p-8 md:p-10 text-white mb-8 shadow-xl">
          ...
          <div className="relative grid lg:grid-cols-[1.3fr_0.7fr] gap-8 items-center">
            <div>
              ...
              <p className="text-blue-100 mt-4 max-w-2xl text-lg">
                ...
                and join a secure video consultation.
              </p>
            ...
            <div className="hidden lg:block bg-white/10 border border-white/20 backdrop-blur-xl rounded-3xl p-6">
        ...
        <section className="bg-white rounded-3xl border border-slate-200 shadow-sm p-6">
          <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-4 mb-6">
            ...
            <Link
              to="/doctors"
              className="inline-flex items-center gap-2 text-blue-600 font-black"
            >
              View all doctors
              <ArrowRight size={18} />
            </Link>
            ...
            {specialties.map((item) => {
              ...
              return (
                <Link
                  ...
                  className="group bg-slate-50 rounded-3xl border border-slate-100 p-6 hover:bg-white hover:shadow-xl hover:-translate-y-1 transition"
                >
                  <div
                  ...
                  <div className="mt-5 text-blue-600 font-black flex items-center gap-2">
                    Consult Now
                    <ArrowRight
                      size={18}
        ...
        <section className="mt-8 bg-white rounded-3xl border border-slate-200 shadow-sm p-6">
          ...
          {doctors.length === 0 ? (
            <div className="text-center text-slate-500 py-10">
              No online doctors available right now.
            </div>
          ) : (
            <div className="grid md:grid-cols-2 xl:grid-cols-3 gap-5">
              {doctors.slice(0, 6).map((doctor, index) => (
                <Link
                  key={doctor.id}
                  to={`/doctor/${doctor.id}`}
                  className="bg-slate-50 rounded-3xl border border-slate-100 shadow-sm hover:bg-white hover:shadow-xl hover:-translate-y-1 transition overflow-hidden"
                >
                  <div className="p-5">
                    <div className="flex justify-between items-start gap-4 mb-4">
                      ...
                      <span className="bg-emerald-100 text-emerald-700 px-3 py-1 rounded-full text-xs font-bold shrink-0">
                        ● Online
                      </span>
                    </div>
                    ...
                    <div className="flex items-center justify-between mt-5">
                      ...
                      <div className="bg-blue-600 text-white px-4 py-3 rounded-2xl font-black hover:bg-blue-700 transition">
                        Consult Now
                      </div>
                    </div>
                  </div>
